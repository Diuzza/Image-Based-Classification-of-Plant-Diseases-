...
def main():
    ...
    if class_btn:
        if file_uploaded is None:
            ...
            with st.spinner('Model working....'): #if an image is actuall uploaded, then the predict function (which implements the logical part of the application) is called.
                plt.imshow(image)
                plt.axis("off")
